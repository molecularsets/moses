...
def get_parser(parser=None):
    ...
    model_arg.add_argument("--n_layers", type=int, default=4,
                           help="Number of transformer enc/dec layers")
    model_arg.add_argument("--hidden", type=int, default=256,
                           help="Hidden size")
    model_arg.add_argument("--num_attention_heads", type=int, default=4,
