...
def get_parser():
    ...
    parser.add_argument(
        "--test_path", type=str, required=True, help="Path to test molecules csv"
    )
    parser.add_argument(
        "--test_scaffolds_path",
        type=str,
    ...
    parser.add_argument(
        "--ks", nargs="+", default=[1000, 10000], help="Prefixes to calc uniqueness at"
    )
    parser.add_argument(
        "--n_jobs", type=int, default=1, help="Number of processes to run metrics"
    )
