...
def get_parser():
    ...
    model_arg.add_argument('--encoder_hidden_size', type=int, default=1024,
    ...
    model_arg.add_argument('--decoder_hidden_size', type=int, default=1024,
    ...
    model_arg.add_argument('--discriminator_layers', nargs='+', type=int, default=[256, 128],
