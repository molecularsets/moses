...
def get_parser():
    ...
    model_arg.add_argument('--encoder_hidden_size', type=int, default=128,
    ...
    model_arg.add_argument('--decoder_hidden_size', type=int, default=128,
                           help='Size of hidden state for lstm layers in decoder')
    model_arg.add_argument('--decoder_num_layers', type=int, default=1,
    ...
    model_arg.add_argument('--latent_size', type=int, default=8,
                           help='Size of latent vectors')
    model_arg.add_argument('--discriminator_layers', nargs='+', type=int, default=[128, 64],
    ...
    train_arg.add_argument('--train_epochs', type=int, default=10,
