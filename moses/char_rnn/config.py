...
def get_parser():
    ...
    model_arg.add_argument("--num_epochs", type=int, default=200, help="Number of epochs")
    model_arg.add_argument('--lr', type=float, default=0.001, help='Initial lr value')
    model_arg.add_argument('--step_size', type=int, default=10, help='Period of learning rate decay')
